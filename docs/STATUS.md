...
groups feature (list, detail, card, settings page with member balances + leave group),
group events (`group_events` table, `useGroupEvents` hook, `useLeaveGroup` hook, `groupEventsQueryOptions`),
